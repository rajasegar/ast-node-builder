...
describe('Core builder api', function() {
  ...
  it('should generate tagged template expressions', function() {

    const fixturePath = 'test/fixtures/templateLiterals';
    const inputFixture = `${fixturePath}.input.js`;
    const outputFixture = `${fixturePath}.output.js`;
    const input = fs.readFileSync(inputFixture, 'utf-8');
    let ast = parse(input);
  ...
  it('should generate unary expressions', function() {
    ...
    const fixturePath = 'test/fixtures/unaryExpression';
    const inputFixture = `${fixturePath}.input.js`;
    const outputFixture = `${fixturePath}.output.js`;
    const input = fs.readFileSync(inputFixture, 'utf-8');
    let ast = parse(input);
  ...
  it('should generate block statements', function() {

    const fixturePath = 'test/fixtures/blockStatement';
    const inputFixture = `${fixturePath}.input.js`;
    const outputFixture = `${fixturePath}.output.js`;
    const input = fs.readFileSync(inputFixture, 'utf-8');
    let ast = parse(input);
